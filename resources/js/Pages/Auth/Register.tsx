...
export default function Register() {
    ...
    return (
        <GuestLayout>
            ...
            <Card className="mx-auto w-full max-w-md border border-zinc-200/80 dark:border-zinc-800 shadow-md bg-white dark:bg-zinc-900">
                ...
                <CardContent className="grid gap-4">
                    <form onSubmit={submit} className="grid gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="username" className="text-zinc-700 dark:text-zinc-350">
                                    Username
                                </Label>
                                <Input
                                    id="username"
                        ...
                        <Button 
                            type="submit" 
                            className="w-full bg-zinc-950 text-zinc-50 hover:bg-zinc-800 dark:bg-zinc-50 dark:text-zinc-950 dark:hover:bg-zinc-200 transition-colors font-semibold mt-2"
                            disabled={processing}
                        >
