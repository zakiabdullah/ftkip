...
## 1. Overview
The **Incident Management** module is a core functional component of the **SPMP-FTKIP** system.
Detailed log of near-miss events, chemical spills, or physical injuries for regulatory reports.
...
- **Vite/React Component**: `resources/js/Pages/IncidentManagement/Index.tsx`
- **TypeScript Interface File**: `resources/js/types/index.d.ts` (contains types for module objects)
- **Laravel Controller**: `app/Http/Controllers/Web/IncidentManagementController.php`
