# Safety Declaration Module

## 1. Overview
The **Safety Declaration** module is a core functional component of the **SPMP-FTKIP** system.
Enforces checkbox acknowledgment of laboratory rules and policies before booking submission.
...
- **Vite/React Component**: `resources/js/Pages/SafetyDeclaration/Index.tsx`
- **TypeScript Interface File**: `resources/js/types/index.d.ts` (contains types for module objects)
- **Laravel Controller**: `app/Http/Controllers/Web/SafetyDeclarationController.php`
