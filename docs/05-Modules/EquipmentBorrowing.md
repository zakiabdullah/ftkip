...
## 1. Overview
The **Equipment Borrowing** module is a core functional component of the **SPMP-FTKIP** system.
Oversees high-value tool loans, return dates, condition checklists, and late notifications.
...
- **Vite/React Component**: `resources/js/Pages/EquipmentBorrowing/Index.tsx`
- **TypeScript Interface File**: `resources/js/types/index.d.ts` (contains types for module objects)
- **Laravel Controller**: `app/Http/Controllers/Web/EquipmentBorrowingController.php`
