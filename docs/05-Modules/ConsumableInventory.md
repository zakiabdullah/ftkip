...
## 1. Overview
The **Consumable Inventory** module is a core functional component of the **SPMP-FTKIP** system.
Tracks levels of filaments, chemical fluids, welding items, and triggers alert on low quantities.
...
- **Vite/React Component**: `resources/js/Pages/ConsumableInventory/Index.tsx`
- **TypeScript Interface File**: `resources/js/types/index.d.ts` (contains types for module objects)
- **Laravel Controller**: `app/Http/Controllers/Web/ConsumableInventoryController.php`
