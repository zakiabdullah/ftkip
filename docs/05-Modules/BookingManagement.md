...
## 1. Overview
The **Booking Management** module is a core functional component of the **SPMP-FTKIP** system.
Interactive wizard for scheduling dates, times, and choosing laboratories and machinery.
...
- **Vite/React Component**: `resources/js/Pages/BookingManagement/Index.tsx`
- **TypeScript Interface File**: `resources/js/types/index.d.ts` (contains types for module objects)
- **Laravel Controller**: `app/Http/Controllers/Web/BookingManagementController.php`
