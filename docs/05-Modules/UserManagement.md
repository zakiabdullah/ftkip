...
## 1. Overview
The **User Management** module is a core functional component of the **SPMP-FTKIP** system.
Create, delete, update accounts, switch permissions, and manage user details.
...
- **Vite/React Component**: `resources/js/Pages/UserManagement/Index.tsx`
- **TypeScript Interface File**: `resources/js/types/index.d.ts` (contains types for module objects)
- **Laravel Controller**: `app/Http/Controllers/Web/UserManagementController.php`
