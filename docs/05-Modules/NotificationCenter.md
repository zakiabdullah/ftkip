...
## 1. Overview
The **Notification Center** module is a core functional component of the **SPMP-FTKIP** system.
Dispatch email alerts and in-app logs upon booking updates, rejection alerts, and damage resolutions.
...
- **Vite/React Component**: `resources/js/Pages/NotificationCenter/Index.tsx`
- **TypeScript Interface File**: `resources/js/types/index.d.ts` (contains types for module objects)
- **Laravel Controller**: `app/Http/Controllers/Web/NotificationCenterController.php`
