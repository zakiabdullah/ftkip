...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 4. Seed Assistant Engineers (Penolong Juruterera)
        $engineers = [
            ...
            ['name' => 'TC. BASRI BIN BIDIN', 'email' => 'basri.bidin@utem.edu.my'],
        ...
        $assistantEngineerRole = Role::firstOrCreate(['name' => 'Assistant Engineer']);
        ...
        // 5. Seed Laboratories (89 labs)
        $this->call(LaboratorySeeder::class);

        // 6. Seed Lecturer / Supervisor accounts
